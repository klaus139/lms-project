...
const ChangePassword: FC<Props> = (props) => {
  ...
  const passwordChanger = async (e: any) => {
    e.preventDefault();
  ...
  return (
    <div className="w-full pl-7 800px:px-5 800px:pl-0 ">
      <h1 className="block text-[25px] 800px:text-[30px] text-center font-Poppins font-[500] text-black dark:text-[#fff] pb-2">
        Change Password
      </h1>
      <div className="w-full">
        <form onSubmit={passwordChanger} className="flex flex-col items-center">
