...
const CourseContent: FC<Props> = ({
  ...
  const handleOptions = () => {
    if (
      ...
      toast.error("Section cannot be empty please fill the required fields");
    }else{
      setActive(active + 1)
      handleCourseSubmit();
    }
            ...
            <>
              ...
              >
                ...
                <div className="flex w-full items-center justify-between my-0">
                  ...
                  {/* arrow buttons for callapsed video content */}
                  ...
                  <>
                    ...
                    {item?.links.map((link: any, linkIndex: number) => (
                      <div key={linkIndex} className="mb-3 block">
                        ...
                        <input
                          type="text"
                          placeholder="Source Code Url...(link to github or hosted code url)"
