  ...
  return (
    <div className="mt-[30px] min-h-screen">
      <div className="grid grid-cols-[75%,25%]">
        ...
        <div className="pt-[85px] pr-8">
          <div className="w-full dark:bg-[#111c43] rounded-sm shadow">
            <div className="flex items-center p-5 justify-between">
              <div className="">
                <BiBorderLeft className="dark:text-[#45cba0] text-[#000] text-[30-px]" />
          ...
          <div className="flex items-center p-5 justify-between">
            <div className="">
              ...
              <h5 className="py-2 font-Poppins dark:text-[#45cba0] text-[#000] text-[20px] font-[400]">
                New Users
              </h5>
            </div>
            <div>
      ...
      <div className='flex mt-[-20px] p-8'>
  <div className='dark:bg-[#111c43] w-[60%] mt-[30px] h-[40vh] shadow-sm m-auto'>
    <OrderAnalytics isDashboard={true} />
  </div>
